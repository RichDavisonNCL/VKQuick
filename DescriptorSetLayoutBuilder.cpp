...
DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithDescriptor(vk::DescriptorType type, uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
...
DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithSamplers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eSampler, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithUniformTexelBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eUniformTexelBuffer, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithStorageTexelBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eStorageTexelBuffer, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithImageSamplers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eCombinedImageSampler, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithSampledImages(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eSampledImage, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithStorageImages(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eStorageImage, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithUniformBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eUniformBuffer, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithStorageBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eStorageBuffer, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithDynamicUniformBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eUniformBufferDynamic, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithDynamicStorageBuffers(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
	return WithDescriptor(vk::DescriptorType::eStorageBufferDynamic, index, count, inShaders, bindingFlags);
}

DescriptorSetLayoutBuilder& DescriptorSetLayoutBuilder::WithAccelStructures(uint32_t index, uint32_t count, vk::ShaderStageFlags inShaders, vk::DescriptorBindingFlags bindingFlags) {
